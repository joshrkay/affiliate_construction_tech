...
export const routeTable: RouteDef[] = [
  ...
  { path: "pricing", load: () => import("./pages/PricingIndexPage").then((m) => ({ Component: m.PricingIndexPage })) },
  { path: "pricing/:slug", load: () => import("./pages/PricingPage").then((m) => ({ Component: m.PricingPage })) },
  { path: "cost-calculator", load: () => import("./pages/CostCalculatorPage").then((m) => ({ Component: m.CostCalculatorPage })) },
  { path: "updates", load: () => import("./pages/UpdatesPage").then((m) => ({ Component: m.UpdatesPage })) },
