...
export const comparisonPages: ComparisonPage[] = [
  ...
  },
  {
    ...
    title: "ServiceTitan vs Housecall Pro (2026) – Field Service Comparison",
    description: "ServiceTitan vs Housecall Pro: pricing, dispatch, and which platform fits your HVAC, plumbing, or electrical business at your size.",
    tools: ["servicetitan", "housecall-pro"],
    keywords: ["servicetitan vs housecall pro", "field service software comparison", "hvac software comparison"],
    tradeId: "hvac",
  },
  {
    slug: "jobber-vs-housecallpro",
    title: "Jobber vs Housecall Pro (2026) – Home Service Software",
    description: "Jobber vs Housecall Pro compared for home service businesses: pricing, scheduling, invoicing, and which is right for your crew size.",
    tools: ["jobber", "housecall-pro"],
    keywords: ["jobber vs housecall pro", "home service software", "plumbing business software"],
    tradeId: "plumbing",
  },
  {
    slug: "bluebeam-vs-procore",
    title: "Bluebeam vs Procore (2026) – Document Management Comparison",
    description: "Bluebeam Revu vs Procore for construction document management: markup workflows, project controls, pricing, and when you need both.",
    tools: ["bluebeam-revu", "procore"],
    keywords: ["bluebeam vs procore", "construction document management", "pdf markup software construction"],
  },
  {
    slug: "stack-vs-bluebeam",
    title: "STACK vs Bluebeam (2026) – Takeoff Software Comparison",
    description: "STACK vs Bluebeam Revu for construction takeoff: cloud vs desktop workflows, measurement tools, pricing, and which fits your estimating team.",
    tools: ["stack", "bluebeam-revu"],
    keywords: ["stack vs bluebeam", "construction takeoff software", "estimating software comparison"],
    tradeId: "estimating-bidding",
  },
  {
    slug: "procore-vs-fieldwire",
    title: "Procore vs Fieldwire (2026) – Field Management Comparison",
    description: "Procore vs Fieldwire for construction field management: task tracking, plan viewing, pricing, and which fits your project size.",
    tools: ["procore", "fieldwire-pro"],
    keywords: ["procore vs fieldwire", "construction field management software", "punch list software"],
    tradeId: "general-contracting",
  },
  {
    slug: "primavera-vs-procore",
    title: "Primavera P6 vs Procore (2026) – Scheduling vs Project Management",
    description: "Oracle Primavera P6 vs Procore: enterprise CPM scheduling vs full construction project management — comparison for commercial GCs.",
    tools: ["oracle-primavera", "procore"],
    keywords: ["primavera vs procore", "construction scheduling software", "enterprise construction software"],
    tradeId: "general-contracting",
  },
  {
    slug: "jobber-vs-procore",
    title: "Jobber vs Procore (2026) – Which Fits Your Business?",
    description: "Jobber vs Procore compared: field service management for home service crews vs enterprise construction project management for GCs.",
    tools: ["jobber", "procore"],
    keywords: ["jobber vs procore", "field service vs construction management", "contractor software comparison"],
  },
];
